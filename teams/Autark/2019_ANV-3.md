...
As mentioned in our opening strategy, we plan to work in a more agile and fluid manner with respect to product development. As we have many initiatives that may require variable and unpredictable amounts of labor, we have devised a framework that specifies our projected capacity on each initiative. Things may change, so we plan to update this chart quarterly and provide explanations for our revisions.

|  Initiative            |  Projected Capacity (%)  |
| ---------------------------- | ----: |
|  01 - Maintaining Open Enterprise      |      6  |
|  02 - Expanding Projects                      |     8  |
|  03 - Expanding Finance | 8 |
| 04 - Expanding Social | 5 |
| 05 - Enabling Organization Insights  | 6 |
| 06 - Enabling New Governance Mechanisms | 8 |
| 07 - Making Aragon More Inclusive | 7 | 
| 08 - Facilitating Smart Contract Based IPFS Pinning |  11| 
| 09 - Strengthening Network Sustainability | 16| 
| 10 - Driving Ecosystem Development|  14| 
| 11 - Supporting AGP Execution |  4 |  
| 12 - Facilitating Developer Support |  7 | 
| 13 - Reinforcing User Research Efforts |  7 | 
